...
功能说明
--------
- 连接 PCAN USB 适配器 (500 kbps)
- NMT 网络管理 (Start / Pre-Op / Reset)
- CiA 402 状态机控制 (Shutdown / Switch On / Enable / Quick Stop / Fault Reset)
- 模式切换 (PP / PV / HM)
- SDO 参数配置 (速度 / 加速度 / 回零参数)
- 运动指令: Profile Position (PP) 和 Profile Velocity (PV)
- 回零流程: 一键回零序列 + 状态轮询
- SDO 快速读写
- 手动 RAW CAN 帧收发
- 快捷回零 / PP 运动 RAW 指令
